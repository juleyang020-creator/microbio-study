...
window.DB.media = [
  ...
  },
  {
    ...
    类别: '特殊培养基',
    小节: [
      { 标题: '组成', 正文: '琼脂糖（自琼脂纯化、去除带电的琼脂胶，呈电中性）溶于电泳缓冲液（TAE/TBE）制成凝胶板，并加核酸染料（如 GelRed、溴化乙锭）。属电泳介质、非培养基，不用于培养微生物。' },
      { 标题: '用途 / 原理', 正文: '用于核酸（DNA/RNA）电泳分离：核酸带负电，在电场中向正极泳动，琼脂糖网孔使小片段移动快、大片段慢，从而按分子量分离，经紫外/蓝光成像。分子检测中用于分析 PCR 扩增产物与酶切片段，确认耐药基因（如 mecA、KPC、NDM）及 PFGE 分子分型。' }
    ],
    关联: ['mrsa-meca', 'kpc', 'ndm']
  }
