...
var APP_VERSION = '20260702-24';
var CACHE = CACHE_PREFIX + 'v70';
...
var CORE = [
  ...
  versioned('./data/breakpoints.js'), versioned('./data/biochem-tests.js'), versioned('./data/ast-alerts.js'), versioned('./data/qc-strains.js'), versioned('./data/ecv.js'), versioned('./data/intrinsic-resistance.js'),
