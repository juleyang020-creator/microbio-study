...
var APP_VERSION = '20260702-10';
var CACHE = CACHE_PREFIX + 'v56';
...
var CORE = [
  ...
  versioned('./data/breakpoints.js'), versioned('./data/biochem-tests.js'), versioned('./data/ast-alerts.js'), versioned('./data/qc-strains.js'),
