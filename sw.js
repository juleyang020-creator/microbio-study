...
var CORE = [
  ...
  versioned('./js/core.js'), versioned('./js/common-names.js'), versioned('./js/view.js'), versioned('./js/validate.js'),
  versioned('./js/app/helpers.js'), versioned('./js/app/sidebar.js'), versioned('./js/app/search.js'),
  versioned('./js/app/compare.js'), versioned('./js/app/bp-table.js'), versioned('./js/app/tools-info.js'), versioned('./js/app/common-names.js'),
  versioned('./js/app/detail.js'), versioned('./js/app/tools-drug.js'), versioned('./js/app/navigation.js'), versioned('./js/app/landing.js'), versioned('./js/app/router.js'),
  ...
  versioned('./data/genetics.js'), versioned('./data/glossary.js'),
  versioned('./data/biochem.js'), versioned('./data/differential.js'), versioned('./data/identification-tables.js'), versioned('./data/morphology.js'), versioned('./data/photos.js'), versioned('./data/photos-atlas.js'), versioned('./data/treatment.js'),
...
var IMAGE_ASSETS = [
  ...
  './img/landing-genetics.svg',
  './img/landing-glossary.svg',
