...
var APP_VERSION = '20260702-33';
var CACHE = CACHE_PREFIX + 'v79';
...
var CORE = [
  ...
  versioned('./data/breakpoints.js'), versioned('./data/biochem-tests.js'), versioned('./data/ast-alerts.js'), versioned('./data/qc-strains.js'), versioned('./data/ecv.js'), versioned('./data/intrinsic-resistance.js'), versioned('./data/site-reporting.js'), versioned('./data/lab-workflow.js'), versioned('./data/microbe-names.js'),
