...
- **菌名速查** (`#/microbe-names`) — 4558 条微生物名称（中文 + 拉丁）索引，含 Bruker MBT 主库 2969 种。命中本库的 186 条名称（覆盖全部 185 个菌，立克次体有属名/spp. 两条记录）跳应用内详情页（离线，标「本库」）；未收录者按拉丁名完整度分流——全写「属 种」的 3314 条跳 NCBI Taxonomy 精确条目，缩写属名/仅属名的 1058 条跳 PubMed 文献检索（均为权威源、国内可达）。
...
| `data/microbe-names.js` | 菌名速查索引（本库详情 / NCBI Taxonomy / PubMed，按拉丁名字母序） | 4558 |
