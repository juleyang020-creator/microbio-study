...
共 126 章、两卷源 PDF、勘误）、`02-药敏标准-CLSI/`、`03-药敏标准-EUCAST/`、
`04-菌种库与仪器/`（Bruker 2969 菌种列表、VITEK2 SOP）。

查 MCM 先用 `MCM分章索引.md` 定位章号再只读单章，不要 grep 整本 6.7 万行。

⚠️ **MCM 的 md 转换件缺章**（全书 154 章，`MCM分章/` 原只有 122 章，缺 32 章；已补回第 23、32、38、51 章，
现 126 章、**缺 28 章**）。仍缺的多是临床核心内容：42 章气单胞菌属、59 章螺杆菌属、71 章抗菌药物耐药机制、113 章抗病毒药物、132 章抗真菌药物，
