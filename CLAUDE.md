...
共 124 章、两卷源 PDF、勘误）、`02-药敏标准-CLSI/`、`03-药敏标准-EUCAST/`、
`04-菌种库与仪器/`（Bruker 2969 菌种列表、VITEK2 SOP）。

查 MCM 先用 `MCM分章索引.md` 定位章号再只读单章，不要 grep 整本 6.7 万行。

⚠️ **MCM 的 md 转换件缺章**（全书 154 章，`MCM分章/` 原只有 122 章，缺 32 章；已补回第 23、32 章，
现 124 章、**缺 30 章**）。仍缺的多是临床核心内容：38 章嗜血杆菌属、42 章气单胞菌属、
51 章军团菌属、59 章螺杆菌属、71 章抗菌药物耐药机制、113 章抗病毒药物、132 章抗真菌药物，
以及**大部分病毒章与全部蠕虫章**。完整清单见 `01-临床微生物学手册-第12版/源文件勘误.md` 第五节。
